...
class Task1:
    ...
    def start(self):
        ...
        ddl_check_query(instance, "DROP DATABASE IF EXISTS default ON CLUSTER cluster0")
        ddl_check_query(instance, "CREATE DATABASE default ON CLUSTER cluster0")
...
class Task2:
    ...
    def start(self):
        ...
        ddl_check_query(instance, "CREATE TABLE a ON CLUSTER cluster0 (date Date, d UInt64, d1 UInt64 ALIAS d+1) ENGINE=ReplicatedMergeTree('/clickhouse/tables/cluster_{cluster}/{shard}', '{replica}', date, intHash64(d), (date, intHash64(d)), 8192)")
